# Echo Admin - 前端转全栈的最短路径

> 基于 Vue 3 + Express + MongoDB 的企业级后台管理架构
>
> 为前端开发者量身定制的全栈学习与实践平台

## 🎯 项目定位

**Echo Admin** 不只是一个后台管理模板，而是一条**为前端开发者设计的全栈学习与成长路径**。

**核心理念**：让前端的知识在后端世界得到回响 —— 用你已经掌握的 JavaScript/TypeScript/JSON 思维，去理解后端和数据库。

**适用人群：**

| 人群 | 价值 |
| :--- | :--- |
| **前端开发者** | 想转全栈？这里有你最友好的入门路径 |
| **全栈初学者** | 从 master 分支入门，到 feature/data-scope 进阶 |
| **独立开发者** | 开箱即用的后台架构，快速交付项目 |
| **团队负责人** | 配置化开发，让团队成员效率翻倍 |

## ✨ 核心亮点

- **📦 配置化开发**：BoxTable 配置化表格，减少 80% 重复代码
- **🔐 完整权限体系**：RBAC + 5级数据权限，开箱即用
- **🎯 前端友好**：Express + MongoDB，JSON 贯穿全链路
- **📚 渐进式学习**：两个分支，从入门到进阶
